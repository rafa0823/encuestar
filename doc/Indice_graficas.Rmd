...
- [**Descriptiva**](./Descriptiva.html): Este tipo de gráficas permite dar resultados de la encuesta de manera resumida y por lo general se enfoca en mostrar el análisis de una sola variable, o la misma diferentes variables expresadas en la encuesta en una sola pregunta. 
