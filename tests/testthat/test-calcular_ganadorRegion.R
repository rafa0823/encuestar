test_that("Estructura de la base de datos de salida", {
  ...
  bd_calcular_ganadorRegion <- encuestar:::calcular_ganadorRegion(diseno = Preguntas$Regiones$diseno,
  ...
  testthat::expect_equal(object = names(bd_calcular_ganadorRegion), c("region", "n()", "geometry", variable, "estimacion"))
