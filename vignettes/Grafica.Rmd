...
```{r}
gr$candidatoOpinion(patron_inicial = opinion,
...
```{r}
gr$candidatoSaldo(patron_opinion = "opinion", candidatos = c("era", "sasil"), positivos = c("Buena"), negativos = c("Mala"),
...
```{r}
Preguntas$Regiones$mapa_degradadoNumerico(variable = "evaluacion_amlo")
```
