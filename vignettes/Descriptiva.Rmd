...
Esta función grafica alguna categoría seleccionada correspondientes a varias variables contenidas en la base de datos. Las variables a graficar deben tener el mismo prefijo en su nombre (llave), pero diferente nombre en su sufijo para poderlas identificar. Para asignar los nombres de cada categoría en la gráfica se apoya del diccionario en el apartado de "tema".
...
Esta función genera una gráfica que muestra el promedio de diferentes variables con valores de tipo numérico. Las variables a graficar deben tener el mismo prefijo en su nombre (llave), pero diferente nombre en su sufijo para poderlas identificar. Para asignar los nombres de cada categoría en la gráfica se apoya del diccionario en el apartado de "tema".
